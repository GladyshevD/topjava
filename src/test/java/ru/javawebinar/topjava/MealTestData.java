...
public class MealTestData {
    ...
    public static List<Meal> meals = Stream.of(MEAL1, MEAL2, MEAL3, MEAL4, MEAL5, MEAL6)
            .sorted((o1, o2) -> o2.getId().compareTo(o1.getId()))
            .collect(Collectors.toList());

    public static List<Meal> mealDelete(int id) {
        List<Meal> mealsDuplicate = meals;
        mealsDuplicate.removeIf((Meal meal) -> meal.getId() == id);
